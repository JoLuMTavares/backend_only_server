...
// ImageFileSchema.plugin(encrypt, {/* encryptionKey : encKey , signingKey : sigKey, */ secret: secKey, excludeFromEncryption: ['user_id']});
...
var ImageFiles = mongoose.model('imageFiles', ImageFileSchema);
